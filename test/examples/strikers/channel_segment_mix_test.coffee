describe 'channel segment mix', ->
  beforeEach -> init
    collections: ['segments', 'channels']
    strikers: ['channel_segment_mix']

  it "#get - returns value", ->
    expect(app.channelSegmentMix.get(5, 2)).equal(0.0)
    expect(app.channelSegmentMix.get(54244, 7)).equal(0.3)
