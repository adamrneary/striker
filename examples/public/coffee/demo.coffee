window.app =
  ...
  schemaMap: (key) ->
    switch key
      when 'stageId'         then app.stages.models
      when 'channelId'       then app.channels.models
      when 'segmentId'       then app.segments.models
      when 'monthId'         then app.months.models
      when 'notFirstStageId' then app.stages.last(app.stages.length - 1)
